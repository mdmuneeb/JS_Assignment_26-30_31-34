...
// if (number === 0){
//     number ++
//     document.write(`The ransom value of dice is ${number}`)
// }else{
//     document.write(`The ransom value of dice is ${number}`)
// }
...
// var number = Math.round(Math.random()*1)+1;
// if (number === 1){
...
// if (number === snumber){
//     alert("Congratulations  <br>You have guessed correct !!!!!")
// }
// else{
...
// var midnightdate = new Date ("Jan 1, 1970 12:00:00") 

// document.write(`Current Date: ${date} <br> `);
// document.write(`Elapsed milliseconds since January 1, 1970: ${midnightdate.getTime()} <br> `);
// document.write(`Elapsed Seconds since January 1, 1970: ${(midnightdate.getTime())/1000} <br> `);
...
// var date = new Date(2020,11,31,12,0,0);
